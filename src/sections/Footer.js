        ...
        <div className="footer__body">
          <div className="footer__content">
            ...
            <form className="footer__form">
              ...
              <button
                role="submit"
                className="btn btn--green footer__form-submit"
              >
                Subscribe
              </button>
            </form>
          ...
          <div className="footer__lists">
            <div className="footer__list-block collapsible">
              ...
              >
                <h3 className="title title--white footer__list-title collapsible__title">
                  CMS Pages
                </h3>
          ...
          <div className="footer__license">
            <p className="footer__license-text">
              &copy; Learnico by Minimal Square. Powered by Webflow
            </p>
