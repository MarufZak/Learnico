            ...
            <div className="courses__carts">
              <div className="courses__cart">
                <header className="courses__cart-header">
                  ...
                  <h3 className="title title--white courses__cart-title">Webflow Basics</h3>
                  <span className="courses__cart-price">$ 24.00 USD</span>
                </header>
                <Button color="green" className="courses__cart-btn">Enroll Course</Button>
                <img className="courses__cart-img" src="./img/courses/courses-1/courses-1.png" srcSet="./img/courses/courses-1/courses-1.webp" alt="course" />
              </div>
              <div className="courses__cart">
                <header className="courses__cart-header">
                  <Flag color="white">Beginner</Flag>
                  <h3 className="title title--white courses__cart-title">Webflow Interactions Masterclass</h3>
                  <span className="courses__cart-price">$ 55.00 USD</span>
                </header>
                <Button color="green" className="courses__cart-btn">Enroll Course</Button>
                <img className="courses__cart-img" src="./img/courses/courses-2/courses-2.png" srcSet="./img/courses/courses-2/courses-2.webp" alt="course" />
              </div>
              <div className="courses__cart">
                <header className="courses__cart-header">
                  <Flag color="white">Beginner</Flag>
                ...
                <Button color="green" className="courses__cart-btn">Enroll Course</Button>
                <img className="courses__cart-img" src="./img/courses/courses-3/courses-3.png" srcSet="./img/courses/courses-3/courses-3.webp" alt="course" />
              </div>
            </div>
        </div>
    </Container>
